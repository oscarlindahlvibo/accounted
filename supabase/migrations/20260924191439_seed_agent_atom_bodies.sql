...
Any other reference file named above is developer material (file formats, integration plumbing) and is not loadable here. Answer from this skill and the references listed, or say what you cannot settle.
$gb$,
    NULL,
    6,
    1,
...
$gb$,
  ...
  (
    ...
    '{}'::text[],
    $gb${"areas":["moms","fakturering"]}$gb$::jsonb,
    1629,
...
UPDATE public.agent_atom_registry SET is_active = false, mcp_exposed = false WHERE id IN ('horizontal/swedish-accounting-compliance/sie4', 'horizontal/swedish-e-invoicing/implementation-guide', 'horizontal/swedish-e-invoicing/market-provider-pricing', 'horizontal/swedish-e-invoicing/peppol-bis-billing', 'horizontal/swedish-e-invoicing/peppol-network', 'horizontal/swedish-project-accounting/implementation-patterns', 'horizontal/swedish-project-accounting/sie4-project-dimensions', 'horizontal/swedish-sie-import-export/encoding', 'horizontal/swedish-sie-import-export/record-types');
