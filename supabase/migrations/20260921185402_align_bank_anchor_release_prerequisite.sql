-- Restore the current bank-release prerequisite on staging branches missing
-- 20260920191000. Its function and triggers are unchanged; this also verifies
-- compatibility with the new bank anchor guards on already-current branches.
