-- Qualify the requested ID in the correlated existence check. An unqualified
-- id resolves to the inner cash_accounts column and silently accepts a missing
-- retirement. A missing or foreign-company row must abort the whole promotion.
